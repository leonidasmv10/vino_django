"""
Django settings for vino_django project.
...
SECRET_KEY = "django-insecure-uq)m(wy*4#3j9^u!0i$k%sf)inrj)**^hfkxb%q#0^8u!f9=91"
...
WSGI_APPLICATION = "vino_django.wsgi.application"
...
STATIC_URL = "static/"
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Ruta donde están los archivos estáticos
]
